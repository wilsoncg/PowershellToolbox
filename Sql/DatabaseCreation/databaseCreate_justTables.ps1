$ServerName='pkh-srv-del12'# the server it is on
$Database='Payments_cwilson_GenesisAudit_20160426' # the name of the database you want to script as objects
$DirectoryToSaveTo='C:\dev\git\UsefulScripts\DatabaseCreation\' # the directory where you want to store them
...
$scripter.Options.WithDependencies= $true # This should be included
